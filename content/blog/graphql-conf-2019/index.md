...
- **GraphQL was not _designed_ to solve important server architecture concerns.**
  ...
  ▶&nbsp;&nbsp; _GraphQL before GraphQL - [Dan Schafer](https://twitter.com/dlschafer) (30min, Opening Talk)_

- **You should care about _all_ the states of what you asked for, all errors are not equal**

  ▶&nbsp;&nbsp; _200 OK! Error Handling in GraphQL - [Sasha Solomon](https://twitter.com/sachee) (30min)_
...
- **[CodeSandbox.io](https://codesandbox.io/)** - I had no idea it was so easy to [import from GitHub](https://codesandbox.io/docs/importing#import-from-github)!
  ...
  ▶&nbsp;&nbsp; _Bringing Databases into Cloud IDEs: CodeSandbox + Prisma = ❤️- [Sara Vieira](https://twitter.com/NikkitaFTW) & [Ives van Hoorne](https://twitter.com/compuives)_
...
- **Get your types! [GraphQL Nexus](https://nexus.js.org/), [TypeGraphQL](https://typegraphql.ml/), [graphql-compose](https://graphql-compose.github.io/)**
  ...
  ▶&nbsp;&nbsp; _SDL as an Artifact: Code-First Schemas and GraphQL Nexus - [Tim Griesser](https://twitter.com/tgriesser) (30min)_

- **[figma-graphql](https://github.com/braposo/figma-graphql) for all sorts of amazing things.**

  ▶&nbsp;&nbsp; _Making design more human with GraphQL - [Bernardo Raposo](https://twitter.com/braposo) (15min)_

- **Compiling your GraphQL queries for _serious_ optimization potential. [Demo](https://try-graphql-jit.boopathi.now.sh/)**

  ▶&nbsp;&nbsp; _Compiling GraphQL to be Blazing Fast - [Rui Araujo](https://twitter.com/raraujoc) (15min)_
...
- **[Apollo Federation](https://www.apollographql.com/docs/apollo-server/federation/introduction/)**
  ...
  ▶&nbsp;&nbsp; _Apollo Schema Federation - [James Baxley](https://twitter.com/jbaxleyiii) (30min)_
...
▶&nbsp;&nbsp;_GraphQL before GraphQL - [Dan Schafer](https://twitter.com/dlschafer) (30min, Opening Talk)_  
▶&nbsp;&nbsp;_Building custom GraphQL tooling for your team - [Sashko Stubailo's](https://twitter.com/stubailo) (30min)_
...
▶&nbsp;&nbsp;_Scaling Your GraphQL Client - [Matt Mahoney](https://github.com/mjmahone) (30min)_  
▶&nbsp;&nbsp;_So you Want to Distribute your GraphQL Schema? - [Marc Andre-Giroux](https://twitter.com/__xuorig__) (30min)_  
▶&nbsp;&nbsp;_Apollo Schema Federation - [James Baxley](https://twitter.com/jbaxleyiii) (30min)_
...
▶&nbsp;&nbsp;_Create Type-Safe Web Applications with ReasonML and GraphQL - [Roy Derks](https://twitter.com/gethackteam) (30min)_  
▶&nbsp;&nbsp;_Moving Fast with End-to-End Type-Safety - [Siegfried Puchbauer](https://twitter.com/ziegfri3d) (25min)_
...
▶&nbsp;&nbsp;_SDL as an Artifact: Code-First Schemas and GraphQL Nexus - [Tim Griesser](https://twitter.com/tgriesser) (30min)_  
▶&nbsp;&nbsp;_Code-first GraphQL Server Development with Prisma - [Nikolas Burk](https://twitter.com/nikolasburk) (30min)_  
▶&nbsp;&nbsp;_Introducing Tartiflette: "SDL First" implementation built for Python 3.6+ - [Stan Chollett](https://twitter.com/tsunammis) (30min)_  
▶&nbsp;&nbsp;_Infinite Backwards Compatibility - Adam D. I. Kramer (30min)_
...
▶&nbsp;&nbsp;_Evolving the Graph - [Jon Wong](https://twitter.com/jnwng) (15min)_  
▶&nbsp;&nbsp;_Making design more human with GraphQL - [Bernardo Raposo](https://twitter.com/braposo) (15min)_
...
▶&nbsp;&nbsp;_We’re gunna program like it’s 1999 - [Lee Byron](https://twitter.com/leeb) (30min, Closing Keynote)_
