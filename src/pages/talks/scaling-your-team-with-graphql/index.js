  ...
  return (
    <Layout hideNav>
      ...
      <div style={{ margin: '50px auto', maxWidth: '750px' }}>
        <h2>Transcript</h2>
        <p>
          1. Today we’re going to talk about scaling your team with GraphQL, and
        ...
        <p>
          ...
          impact focused strategy, design, and development agency in Charlotte,
          NC. You can find me on Twitter @JoelSocialized, or reach me at my
          email hello@joel.software.
        </p>
        <p />
        <p>
          ...
          familiar with the GraphQL Community; on the left is Lee Byron, one of
          three co-creators of GraphQL and recently coronated Chair of the
          GraphQL Foundation governing board. In the center is Sashko Stubailo,
          a long-time contributor to the GraphQL community and someone who I
          personally learned a lot from when I was first getting into GraphQL in
          2016/2017 while he was at Apollo and posting a lot of content on the
          subject. And lastly, on the right, that’s me. I think I’m wearing that
          shirt right now…
        </p>
        <p />
        <p>
          ...
          conference, it’s the people in the background who I recognize from the
          time we spent together during the talks and after-hours at biergartens
          and after parties talking about our work, sharing stories, and
          learning from one another.
        </p>
        <p />
        <p>
          If you’re thinking about going to a conference, do it! Whether or not
          it’s GraphQL Conf, choose one that aligns with your personal interests
          and professional goals and go! Conferences are more than just the
          learnings from the stage, may conferences including GraphQL Conf are
          live-streamed for free and the talks are posted online later. You can
          watch this content at 2x speed in the comfort of your own home if your
          primary goal is learnings from the stage, but I say it's much more
          than that. Go, and build relationships with the people you meet there
          – that is where the true value of a conference is found.
        </p>
        <p />
        <p>
          3. So – have you heard about GraphQL? I hope you have, and that’s why
          you’re here right now listening to me share my learnings.{' '}
        </p>
        <p />
        <p>
          4. You may be at any number of points in your GraphQL journey. You may
          be API Creators, Consumers, or just getting familiar with the
          concepts. You may feel confident in your knowledge, or confused by the
          ecosystem. Wherever you’re at, I’d like to start by talking about the
          specification so we can start with some shared concepts and
          understandings.
        </p>
        <p />
        <p>
          5. This comes straight from the open source specification, the current
          working draft available on GitHub and at
          https://graphql.github.io/graphql-spec/.
        </p>
        <p />
        <p>
          If this is enough for you, I’ll take volunteers to give the rest of
          the talk, if not let’s dive in a bit and work through these concepts.
        </p>
        <p />
        <p>6. So, what is GraphQL?</p>
        <p />
        <p>
          7. GraphQL is an agreement (hint: relationship) between the client and
          the server
        </p>
        <p />
        ...
        <p>
          ...
          that run in order to retrieve data from your various services, but the
          method by which you execute that retrieval within those services, or
          the protocols you use to communicate with them, is explicitly not
          defined by GraphQL.
        </p>
        <p />
        <p>12. Still have some questions? Let’s refactor your mind from REST</p>
        <p />
        <p>
          13. I’m going to use REST as a framework for further discussion, as I
          am assuming most of you are more familiar with REST as a mental model.
        </p>
        <p />
        <p>
        ...
        <p>
          ...
          cracked open the 403 pages on RESTful Web APIs from O’Reilly, and I’m
          still uncertain about some of those concepts or when exactly I want to
          use some of these verbs, as you may be also.
        </p>
        <p />
        <p>
          Regardless, if you want to GET data in GraphQL it is called a Query.
          If you want to change data in GraphQL it is called a Mutation. If you
          want to subscribe to the changes of that data, is is called a
          Subscription.
        </p>
        <p />
        ...
        <p>
          ...
          previous things through a GET request where you specify entities in a
          query param.
        </p>
        <p />
        <p>
        ...
        <p />
        <p>
          Here we have the Project type, and it has a Name which is a String, a
          Tagline which is also a string, and n contributors.
        </p>
        <p />
        ...
        <p />
        <p>
          24. Now we may also want to get a list of contributors to our project,
          and since we defined that relationship previously it’s easy to request
          the data we need by adding contributors, and specifying username as
          the data to return.
        </p>
        <p />
        <p>
        ...
        <p>
          ...
          another request… In GraphQL you can often request all of the data you
        ...
        <p>
          ...
          recently made available through Cornell which postulated a conversion
          to GraphQL from REST could reduce total data-field requests by 94%,
          and total data transfers by 99%. You can go read the HackerNews post
          on this research to see how people responded to those claims, but what
          I’d like to leave with you is the sense that significant reduction in
          data retrieval and data transfer can be achieved with GraphQL. Data
          transfer is expensive, both for your services, networks, and certainly
        ...
        <p>
          ...
          GraphQL you’re getting Type-safety out of the box which allows you to
          reason about the shape of your data, and the content of your responses
          and mutations.
        </p>
        <p />
        <p>
          28. Documentation - this was particularly exciting for me when I first
          began working with GraphQL as I had recently spent a significant
          amount of time documenting API endpoints. Out of the gate with GraphQL
          and features like introspection you’ll get documentation. Consumers of
          your API need to know what data is available, and what manipulations
          are possible. GraphQL Schema gives you that data by default. There are
          also may tools available from the community to help you add to the
          documentation.
        </p>
        <p />
        <p>
          ...
          interactions with your data, so you can direct your focus on building
          edge case data requirement operations instead of common CRUD
          operations.
        </p>
        <p />
        <p>
          Because of GrahQL’s schema definitions, you can also quickly mock our
          data responses for your tests – and since I know we all right tests
          for our code all the time – this is a huge productivity win!
        </p>
        <p />
        <p>
        ...
        <p />
        <p>
          You will certainly be able to find guidance on these and other topics
          from the GraphQL community and the many reference implementations and
          open-source tools. However, you won’t find these defined in the spec,
          and you may not find a clear and final answer on how to handle these
        ...
        <p>
          ...
          does not answer… that’s because [these questions] were already solved
          by FB in 2012” - Dan Schafer (GraphQL Co-Creator) GraphQL before
          GraphQL — Dan Schafer
        </p>
        <p />
        ...
        <p />
        <p>
          40. Or maybe, and more likely, your implementation looks a little more
          like this - where you have microservice(s), database(s), and other
          third party APIs or legacy RESTful APIs you still maintain and
          interface with.
        </p>
        <p />
        <p>
          41. GraphQL can be the gateway to all of these individual services and
          data layers.
        </p>
        <p />
        <p>
          42. GraphQL can be where you DTR, define the relationships, and create
          a single graph of the necessary data for your clients.
        </p>
        <p />
        <p>
        ...
        <p />
        <p>
          Given that many of you are working in different languages, toolchains,
          implementation constraints, and organizational strategies, let’s talk
          about building a GraphQL API through principles - ideals that you and
          your team can strive for as you make decisions and compare these
          concepts to your individual constraints.
        </p>
        <p />
        <p>
          44. We’ll do this by looking at Principled GraphQL, a resource shared
          by the Apollo organization based on their wealth of experience
          building and hosting GraphQL APIs and associated tooling.
        </p>
        <p />
        <p>
        ...
        <p />
        <p>
          45. One Graph - Your company should have one unified graph, instead of
          multiple graphs created by each team.
        </p>
        <p />
        <p>
        ...
        <p>
          ...
          abstraction layer that provides flexibility to consumers while hiding
          service implementation details.
        </p>
        <p />
        <p>
          49. Use an Agile Approach to Schema Development - The schema should be
          built incrementally based on actual requirements and evolve smoothly
          over time.
        </p>
        <p />
        <p>
          50. Iteratively Improve Performance - Performance management should be
          a continuous, data-driven process, adapting smoothly to changing query
          loads and service implementations.
        </p>
        <p />
        <p>
        ...
        <p />
        <p>
          Logging should be one of the first things you consider, not one of the
          last. In order to understand your graph usage and iteratively improve
          performance (Principle #6) you’re going to need this information.
        </p>
        <p />
        <p>
        ...
        <p />
        <p>
          With all of these things in mind, and considering all of the benefits
          of GraphQL - what do you think the most important thing about GraphQL
          is? I have my own opinion, which I will share. But I’d like you to
          consider for a moment what is most impactful for you and your team.
        </p>
        <p />
        <p>
        ...
        <p />
        <p>
          58. So with many data stores, you might be asking how will I generate
          this schema?
        </p>
        <p />
        <p>
          59. When you read GraphQL Principle #2, you’ll probably see the value
          in federating the schema authorship as well.
        </p>
        <p />
        <p>
        ...
        <p />
        <p>
          64. Point-point communication without GraphQL as a requirement can be
          optimized in a way that is free of client constraints and use cases
        </p>
        <p />
        <p>
          65. Use cases are the relationship between features and the necessary
          data.
        </p>
        <p />
        <p>66. Don’t design your schema based on your services architecture.</p>
        <p />
        <p>
        ...
        <p>
          ...
          `graphql get-schema` to hit your API and create a schema.graphql file
        ...
        <p />
        <p>
          77. In this example, I’ve asked for a number of fields when creating a
          “Beans” fragment, however the existing type does not have a
          `roastTime` property and i’m getting immediate feedback about that at
          the authorship stage, rather than in a build or runtime error.{' '}
        </p>
        <p />
        <p>
        ...
        <p>
          ...
          the CLI is graphql-voyager. Voyager allows you to visualize your data
          schema and relationships between types. Rather than spelunking into
          your schema or navigating docs to see what is available, you can
          explore the data types visually and quickly find information on data
        ...
        <p>
          ...
          and sorting without ever writing a line of code. Validate the result,
          and save the query in your application.
        </p>
        <p />
        <p>
        ...
        <p />
        <p>
          Apollo is certainly one of the most popular options, and comes out of
          the gate with things like local caching, and optimistic updates,
          though I have found Apollo client to be a bit verbose at times.
        </p>
        <p />
        <p>
          Relay from facebook is also quite popular if you’re working in React,
          and comes with powerful mocking capabilities and custom GraphQL
          directives.
        </p>
        <p />
        <p>
          If you’re working with AWS AppSync you might find yourself using the
          Amplify client, though it doesn’t have some of the bells and whistles
          of the other options.
        </p>
        <p />
        <p>
          Finally, if you don’t need some of the custom features of these other
          clients or aren’t interested in learning their intricacies, try out
          graphql-relay from Prisma which is a minimal GraphQL client that will
          get you up and running quickly.
        </p>
        <p />
        <p>
          84. Generate mock data! The graphql-cli also is supposed to get a
          graphql-faker plugin soon, which should make generating mock data even
          easier.{' '}
        </p>
        <p />
        ...
        <p />
        <p>
          87. For me, one of the big takeaways from GraphQL conf, and prisma day
          which I also attended was the assumptive tone from many of speakers
          that you would want a type safe codebase. I’ve long been a fan of
          TypeScript for example, but have found it to be somewhat polarizing as
          a topic. At GraphQL Conf and Prisma Day there was plenty of support
          for type safety in JavaScript whether with TypeScript or Flow.
        </p>
        <p />
        <p>
        ...
        <p>
          ...
          better abstractions, better syntax, and better mental models over the
          last 30 years of the web - the assertion being that GraphQL would be
          one of the better mental models that could take us forward.
        </p>
        <p />
        ...
        <p />
        <p>
          95. GraphQL is an agreement (relationship) between the client and the
          server
        </p>
        <p />
